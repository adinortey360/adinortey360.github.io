$.ajax({
    ...
    content.skill.forEach(element => {
      $("#skill").append('<div class="skill-lt"> <h6>'+element.skill+'</h6><span class="count-inner"><span>'+(element.rating*100).toString()+'</span>%</span> <div class="skill-bar"> <div class="skill-bar-in" style="width: '+(element.rating*100).toString()+'%;"></div> </div> </div>');
    });
  });